...
public class SnowflakeCommandTopTests
{
  ...
  public void Top_ShouldFill_SELECT_TOP_FROM_ForSimpleClass()
  {
    ...
    // Assert
    sql.Should().Be("SELECT TOP 3 a.ID, a.PROP_1 FROM DATABASE.SCHEMA.SNOWFLAKE_CLASS1 AS a");
  }
  ...
  public void Top_ShouldFill_SELECT_DISTINCT_TOP_FROM_ForSimpleClass()
  {
    ...
    // Assert
    sql.Should().Be("SELECT DISTINCT TOP 3 a.ID, a.PROP_1 FROM DATABASE.SCHEMA.SNOWFLAKE_CLASS1 AS a");
  }
